...
namespace NSGTransportManagement.Classes
{
    ...
    class GlobalClass
    {
        ...
        private static Image currentDocument;
        private static string currentDocumentName;
        ...
        public static Image CurrentDocument
        {
            get
            {
        ...
        public static string CurrentDocumentName
        {
            get
            {
